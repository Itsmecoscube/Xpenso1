    ...
    <div class="reminders-page">
        ...
        <div class="reminders-page-left">
            ...
            <div class="reminders-page-left-menu">
                <span class="reminders-page-text1"><a href="../transactions-html/index1.php"><button class="menu-button1" style="background-color:#65f9c5;"><span class="menutext">Transactions</span></button></a></span>
